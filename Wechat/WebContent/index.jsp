...
<body>
			   ...
			   <div class="wmuSliderWrapper">
				   <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	<div class="slider_text">
				   	  <h1>欢迎来到<span class="head">北京旅游！</span></h1>
				   	  <h2><span class="green">Welcome to</span> Bejing Travel !</h2>
				   	  <h2>Your openID=<%=OpenID%></h2>
				   	  <h2>Your path = <%=path %></h2>
				   	  <div class="m_1"><span class="left_line"> </span> <p>为您提供地理位置相关服务</p><span class="right_line"> </span></div>
				   	  <div class="social">	
						   <ul>	
			...
			<p class="m_5">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna<br> aliquam erat volutpat. Ut wisi enim ad minim veniam,.</p>
				<div class="container"> 
					...
					<div class="portfolio web mix_all" data-cat="web" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper">		
							<a href="single.html" class="b-link-stripe b-animate-go  thickbox">
						     <img src="images/pic9.jpg" /><div class="b-wrapper"><h2 class="b-animate b-from-left    b-delay03 "><img src="images/icon-eye.png" alt=""/></h2>
						  	<p class="b-animate b-from-right    b-delay03 ">Lorem ipsum dolor sit amet.<br><span class="m_4">Photography</span></p></div></a>
		                </div>
					</div>				
    ...
    <div class="facts">
	  <div class="wrap">
	   ...
	   <div class="m_3"><span class="left_line2"> </span><img src="images/heart1.png" alt=""/><span class="right_line2"> </span></div>
	    <div class="facts_box">
    ...
    <div class="footer-top" id="contact">
	  <div class="wrap">
	   ...
	   <div class="map">
		<image src="http://api.map.baidu.com/staticimage?center=116.353903,39.987322&width=300&height=200&zoom=15"></image>
   ...
   <div class="footer-bottom">
	  <div class="wrap">
		<div class="section group">
				...
				<div class="col_1_of_5 span_1_of_5">
					<ul class="m_11">
						<li>euismod tincidunt<img src="images/heart.png" alt=""/>laoreet dolore magna aliquam consectetuer adipiscing</li>
					</ul>
					<div class="copy">
		             <p>© 2014 Template </p>
		           </div>
